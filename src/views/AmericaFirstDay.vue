<template>
    <div class="q-pa-md items-start q-gutter-md">
        <div>
            <div class="text-left text-h4" style="font-weight: bold;">アメリカ渡航 1日目</div>
        ...
        <div>
            <p style="font-size: 1rem; line-height: 180%;">
                ...
                <br>
                また、ホテルや飛行機の値段は基本的に「信頼」と「価格」のトレードオフだと思った方がよい。
                ...
                <br>
                なんにせよ、口コミなどを見て「信頼」と「価格」が釣り合っている会社のサービスを受けるのが一番である。
